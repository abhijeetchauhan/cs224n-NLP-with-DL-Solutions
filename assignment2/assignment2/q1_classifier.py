...
class SoftmaxModel(Model):
    ...
    def add_placeholders(self):
        ...
        ### YOUR CODE HERE
        conf = Config()
        batch_size,n_features,n_classes = conf.batch_size,conf.n_features,conf.n_classes


        self.input_placeholder = tf.placeholder(tf.float32,(batch_size,n_features))
        self.labels_placeholder = tf.placeholder(tf.float32,(batch_size,n_classes))
        ### END YOUR CODE
    ...
    def add_prediction_op(self):
        ...
        ### YOUR CODE HERE
        conf = Config()
        b = tf.Variable(tf.zeros((conf.batch_size,1)))
        n_features = conf.n_features
        batch_size = conf.batch_size
        W = tf.Variable(tf.zeros((n_features,conf.n_classes)))
