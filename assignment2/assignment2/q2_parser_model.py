...
class ParserModel(Model):
    ...
    def add_placeholders(self):
        ...
        ### YOUR CODE HERE
        conf = Config()
        self.input_placeholder = tf.placeholder(tf.int32,(None, conf.n_features))
        self.labels_placeholder = tf.placeholder(tf.float32, (None, conf.n_classes))
    ...
    def add_embedding(self):
        ...
        embeddings = tf.reshape(embeddings, (-1,conf.n_features*conf.embed_size))
        ### END YOUR CODE
        return embeddings
    ...
    def add_prediction_op(self):
        ...
        ### YOUR CODE HERE
        conf = Config()
        b1 = tf.Variable(tf.zeros((conf.hidden_size)))
        b2 = tf.Variable(tf.zeros((conf.n_classes)))
        xavier_init = xavier_weight_init()
        W = tf.Variable(xavier_init((conf.n_features*conf.embed_size,conf.hidden_size)))
        U = tf.Variable(xavier_init((conf.hidden_size,conf.n_classes)))
